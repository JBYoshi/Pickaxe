...
@Plugin(id = "pickaxe", name = "Pickaxe", version = "1.0-SNAPSHOT")
public final class PickaxePlugin {
    ...
    public void initialize(GameInitializationEvent event) {
        installer = new PluginInstaller(Sponge.getPluginManager()
                ...
                .getSource().map(Path::getParent).orElseGet(() -> {
                    // It can be absent during development. Try reflection to
                    // access the Sponge configuration.
                    try {
